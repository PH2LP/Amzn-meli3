#!/usr/bin/env python3
"""
22_get_product_videos.py
═══════════════════════════════════════════════════════════════════════════════
¿Qué hace?
    Obtiene videos de productos de Amazon

USO:
    python3 22_get_product_videos.py <ASIN>

Obtiene TODOS los videos de un producto Amazon (listing + customer videos).

Uso:
    python3 22_get_product_videos.py B09X7MPX8L
    python3 22_get_product_videos.py B09X7MPX8L --json
    python3 22_get_product_videos.py B09X7MPX8L --download
═══════════════════════════════════════════════════════════════════════════════
"""
