#!/usr/bin/env python3
# ═══════════════════════════════════════════════════════════════════════════════
# 01_search.py - BUSCAR PRODUCTOS EN AMAZON
# ═══════════════════════════════════════════════════════════════════════════════
# 
# ¿Qué hace?
#   Busca productos en Amazon usando keywords y guarda los ASINs encontrados.
#   Los resultados se guardan en asins.txt para luego publicarlos.
# 
# Comando:
#   python3 01_search.py
# 
# ═══════════════════════════════════════════════════════════════════════════════
import os
import sys
